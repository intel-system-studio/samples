...
echo %CC% %CC_FLAGS% /Fe%DESTDIR%%SAMPLE%.exe %DESTDIR%%SAMPLE%.obj %LINK_FLAGS%
%CC% %CC_FLAGS% /Fe%DESTDIR%%SAMPLE%.exe %DESTDIR%%SAMPLE%.obj %LINK_FLAGS%
...
echo "     build run [release|debug] - run %SAMPLE% sample
