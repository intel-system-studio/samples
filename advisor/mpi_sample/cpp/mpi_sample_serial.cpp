...
//ADVISOR COMMENT: Uncomment the #include <advisor-annotate.h> line after you've modified the Makefile to allow you to use Advisor annotations
...
{ 
 ...
 the processes */
  ...
  //ADVISOR COMMENT: Uncomment the three annotations below to model parallelizing the body of this for() loop
  //ADVISOR COMMENT: Don't forget to uncomment the #include "advisor-annotate.h" at the top and modify the Makefile
