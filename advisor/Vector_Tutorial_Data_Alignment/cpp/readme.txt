These files (dataAlignment.cpp, peelRemainder.cpp) are meant to be used with the "Data 
Alignment, Padding, & Peel/Remainder Loops" tutorial for Intel® Advisor XE 2016. They are 
intended to be compiled with the Intel C++ Compiler in Microsoft* Visual Studio 2010. The 
process may be significantly different using other compilers or in other environments, and 
in fact, these particular files may not compile at all outside of their intended environment
(Intel C++ Compiler on a Windows* operating system).

In order to analyze these files as intended with Intel® Advisor XE 2016, you will also need
to change their Intel® Advisor XE 2016 Project Properties. For each project, right click the 
project name in the solution explorer and go to "Intel Advisor XE 2016" in the dropdown, then 
select "Project Properties...". Under "Survey Hotspots/Suitability Analysis", expand the 
"Advanced" section, and set the "Sampling Interval" to 1 and the "Duration Time Estimate" 
to "Under 1 minute".

********************
* PeelAndRemainder *
********************
To compile the PeelAndRemainder project as intended, right click the project name and under 
"Intel Compiler", select "Use Intel C++", and perform the following steps.
...
3. When all flags are set, select "Build" on the tool bar, and select "Build 
   PeelAndRemainder".

********************
*  DataAlignment   *
********************
To compile the DataAlignment project as intended, right click the project name and under 
"Intel Compiler", select "Use Intel C++", and perform the following steps.
...
2. Right click the project name in the solution explorer and select "Properties". Under 
   Configuration Properties>C/C++, ensure that you use and exclude the following flags as 
	...
	/Qopt-report-filter="dataAlignment.cpp,44-56"
...
3. When all flags are set, select "Build" on the tool bar, and select "Build DataAlignment".

See the online video https://software.intel.com/en-us/videos/data-alignment-padding-and-peel-remainder-loops
