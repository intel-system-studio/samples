...
To compile each project as intended, right click the project name and under "Intel Compiler", 
select "Use Intel C++", and perform the following steps.
...
3. When all flags are set, select "Build" on the tool bar, and select "Build Solution" or 
	 "Build Contiguity"/"Build StrideTrickiness".

4. To switch between Contiguity and StrideTrickiness for running and analyzing the
   executables, right click the project name you wish to use and select "Set as StartUp 
	 Project".
