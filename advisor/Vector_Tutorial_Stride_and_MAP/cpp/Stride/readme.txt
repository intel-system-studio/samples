This file (stride.cpp) is meant to be used with the "Stride and Memory Access Patterns" 
tutorial for Intel® Advisor XE 2016. It is intended to be compiled with the Intel C++ 
Compiler in Microsoft* Visual Studio 2010. The process may be slightly different using other 
compilers or in other environments.
...
See the online video: https://software.intel.com/en-us/videos/stride-and-memory-access-patterns
